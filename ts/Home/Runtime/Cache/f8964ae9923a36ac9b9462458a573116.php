...
<div id="templatemo_right">
    ...
    <div id="content">
        ...
        <?php if(!empty($forword)): ?><strong>上一篇：</strong><a href="__URL__/details/id/<?php echo ($forword["id"]); ?>"><?php echo ($forword["title"]); ?></a><br><?php endif; ?>
        <?php if(!empty($next)): ?><strong>下一篇：</strong><a href="__URL__/details/id/<?php echo ($next["id"]); ?>"><?php echo ($next["title"]); ?></a><?php endif; ?>
		</p>
    <div>
</div>
</div>
