...
jQuery(function() {
    ...
    a.fn.ace_wysiwyg = function(c, h) {
        ...
        var g = {
            ...
            font: {
                values: ["Simsun", "Times News Roman", "Arial", "Courier", "Comic Sans MS", "Helvetica", "Open Sans", "Tahoma", "Verdana"],
                icon: "icon-font",
                title: "字体"
            },
            fontSize: {
            ...
            for (var n in f) {
                if (f.hasOwnProperty(n)) {
                    ...
                    case "insertFile": //插入文件
                        r += ' <a class="btn btn-sm "' + q + ' data-toggle="modal" data-target="#modal-insertFile" title="' + p.title + '"><i class="' + p.icon + '"></i></a> ';
                        break;
                    case "font":
                    ...
                    case "createLink":
                        ...
                        break;
                    case "insertImage":
                        r += ' <a class="btn btn-sm ' + p.button_insert_class + '"' + q + ' data-toggle="modal" data-target="#modal-insertImage" title="' + p.title + '"><i class="' + p.icon + '"></i></a> ';
                        break;
                    case "insertCode":
                        r += ' <a class="btn btn-sm ' + p.button_insert_class + '"' + q + ' data-toggle="modal" data-target="#modal-insertCode" title="' + p.title + '"><i class="' + p.icon + '"></i></a> ';
                        break;
                    case "foreColor":
                    case "backColor":
