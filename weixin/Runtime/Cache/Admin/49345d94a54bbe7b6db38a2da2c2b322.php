...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/weixin/Public/Admin/css/base.css?v=<?php echo SITE_VERSION;?>" media="all">
    <link rel="stylesheet" type="text/css" href="/weixin/Public/Admin/css/common.css?v=<?php echo SITE_VERSION;?>" media="all">
    <link rel="stylesheet" type="text/css" href="/weixin/Public/Admin/css/module.css?v=<?php echo SITE_VERSION;?>" />
    <link rel="stylesheet" type="text/css" href="/weixin/Public/Admin/css/style.css?v=<?php echo SITE_VERSION;?>" media="all">
	<link rel="stylesheet" type="text/css" href="/weixin/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css?v=<?php echo SITE_VERSION;?>" media="all">
     <!--[if lt IE 9]>
    ...
    <script type="text/javascript" src="/weixin/Public/Admin/js/jquery.mousewheel.js?v=<?php echo SITE_VERSION;?>"></script>
    <!--<![endif]-->
    
	<link rel="stylesheet" href="/weixin/Public/admin/js/codemirror/codemirror.css?v=<?php echo SITE_VERSION;?>" />
	<link rel="stylesheet" href="/weixin/Public/admin/js/codemirror/theme/<?php echo C('codemirror_theme');?>.css?v=<?php echo SITE_VERSION;?>" />
	<style>
		...
		#preview_window.loading{
			background: url('/weixin/Public/static/thinkbox/skin/default/tips_loading.gif') no-repeat center;
		}
...
'model'=>'Example',		//要查的表
    ...
    <script type="text/javascript" src="/weixin/Public/static/think.js?v=<?php echo SITE_VERSION;?>"></script>
    <script type="text/javascript" src="/weixin/Public/Admin/js/common.js?v=<?php echo SITE_VERSION;?>"></script>
    <script type="text/javascript">
        +function(){
	...
	<script type="text/javascript" src="/weixin/Public/admin/js/codemirror/codemirror.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/weixin/Public/admin/js/codemirror/xml.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/weixin/Public/admin/js/codemirror/javascript.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/weixin/Public/admin/js/codemirror/clike.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/weixin/Public/admin/js/codemirror/php.js?v=<?php echo SITE_VERSION;?>"></script>

	<script type="text/javascript" src="/weixin/Public/static/thinkbox/jquery.thinkbox.js?v=<?php echo SITE_VERSION;?>"></script>
