					...
					<div class="page-content">
						...
						<div class="row">
                          <div class="control-group">
							<div class="col-xs-12">
                                <form id="myform" class="form-horizontal" role="form" enctype="multipart/form-data" action="/index.php/Admin/Article/insert" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                            <span class="input-icon input-icon-right">
											    <input type="text" placeholder="标题" style="width:348px"name="title" required />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" placeholder="关键字" name="keywords" class="col-xs-10 col-sm-5" required />
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										...
										<div class="col-sm-9">
                                            <textarea row="10" placeholder="描述" style="height:100px" name="description" class="autosize-transition col-xs-10 col-sm-5" required></textarea>
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" value="0" name="sort" class="col-xs-10 col-sm-5">
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                            ...
                                            <label for="unload" class="btn btn-xs btn-info"  onmouseover="document.getElementById('upload').style.display='block';" class="file1">点击浏览...</label> 
                                            <input type="file" name="image" onchange="document.getElementById('viewfile').value=this.value;this.style.display='none';" class="file" id="upload" style="display: block;"> 
										</div>
									</div>
									<div class="space-4"></div>
