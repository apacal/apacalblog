...
-->
	...
	<body>
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active"><a href="/index.php/Admin/Link/manage">友情链接管理</a></li>
						</ul><!-- .breadcrumb -->
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								<a href="/index.php/Admin/Link/manage">友情链接管理</a>
								<small>
									<i class="icon-double-angle-right"></i>
									 友情链接列表
								</small>
                                    ...
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                    ...
                                                    <td>
                                                        <a href="/index.php/Admin/Link/edit/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a>
                                                    </td>
                                                    ...
                                                    <td class="hidden-480">
                                                        <span class="label label-sm label-warning"><?php echo ($vo["status"]); ?></span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                            ...
                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                            <a href="/index.php/Admin/Link/edit/id/<?php echo ($vo["id"]); ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                <span class="green">
                                                              ...
                                                              <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                  ...
                                                                  <div class="modal-footer">
                                                                    ...
                                                                    <a href="/index.php/Admin/Link/del/id/<?php echo ($vo["id"]); ?>"><button type="button" class="btn btn-primary">确定</button></a>
                                                                  </div>
                                                                </div><!-- /.modal-content -->
                                                              </div><!-- /.modal-dialog -->
                                                            </div><!-- /.mod -->
		...
		<script src="http://218.244.140.70/Public/ace/js/FixedColumns.min.js"></script>
		<script type="text/javascript">
			jQuery(function($) {
				...
				var oFC = new FixedColumns( oTable1, {
                    "iLeftColumns": 4
                } );
