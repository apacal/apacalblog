	...
	<body class="skin-1">
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div id="manage-content" class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <!-- ====================================   全选，删除等等　==================================-->
                                    <div class="action-buttons" style="margin-left:180px; position: absolute;z-index: 5;left: 50px;top: 20px;">
                                        <a href="/index.php/Admin/Article/add"  data-toggle="tooltip" title="增加">  
                                            <span class="blue"><i class="icon-plus-sign purple bigger-150"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>  
                                        </a>  
                                        <a data-toggle="tooltip" title="删除">  
                                            <span class="red"><i id="startDelete" class="icon-trash bigger-150"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> 
                                        </a> 
                                        <a data-toggle="tooltip" title="全选/全不选">  
                                            <span class="green"> <i id="selectAllCheck" style="width:19px" class="icon-check-empty bigger-150"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> 
                                        </a>  
                                    </div>
                                    <!-- ====================================   全选，删除等等　==================================-->
                                    ...
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                    <td class="center">
                                                        <label>
                                                            <input type="checkbox" class="ace" name="checkid" value="<?php echo ($vo["id"]); ?>" />
                                                            <span class="lbl"></span>
                                                        </label>
                                                    </td>
                                                    ...
                                                    <td class="center">
                                                        <a href="/index.php/Admin/Article/edit/id/<?php echo ($vo["id"]); ?>"><b><?php echo ($vo["title"]); ?></b></a>
                                                    </td>
                                                    <td><?php echo (msubstr($vo["description"],0,70)); ?></td>
                                                    <td><?php echo ($vo["sort"]); ?></td>
                                                    <td><?php echo (date("Y-m-d H:i", $vo["createtime"])); ?></td>


                                                    <td >
                                                        <?php if($vo["status"] == 1): ?><span class="label label-success arrowed">允许</span>
                                                        <?php else: ?>
                                                            <span class="label label-info arrowed-right">禁止</span><?php endif; ?>
                                                    </td>
                                                    <td>
                                                        <div style="width:150px" class="visible-md visible-lg hidden-sm hidden-xs action-buttons">

                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                            <a href="<?php echo U('Home/Article/view', array('id' => $vo['id']));?>" target="_blank" class="tooltip-info" data-rel="tooltip" title="View">
                                                                <span class="blue">
		...
		<script type="text/javascript">
			jQuery(function($) {
                ...
                /*var addBtn = '<label  class="visible-md visible-lg hidden-sm hidden-xs action-buttons">&nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo U('Home/Article/view', array('id' => $vo['id']));?>" target="_blank" class="tooltip-info" data-rel="tooltip" title="View"> <span class="blue"> <i class="icon-zoom-in bigger-120"></i> </span> </a> &nbsp;&nbsp;&nbsp;&nbsp; <a href="/index.php/Admin/Article/edit/id/<?php echo ($vo["id"]); ?>" class="tooltip-success" data-rel="tooltip" title="Edit"> <span class="green"> <i class="icon-edit bigger-120"></i> </span> </a> &nbsp;&nbsp;&nbsp;&nbsp; <a data-toggle="modal" data-target="#modal-<?php echo ($vo["id"]); ?>" class="tooltip-error" data-rel="tooltip" title="Delete"> <span class="red"> <i class="icon-trash bigger-120"></i> </span> </a> </label>';
                 var addBtn = '<label class="action-buttons" style="margin-left:80px">' +
                                    '<a class="tooltip-info" data-rel="tooltip" title="Add">' + 
                                        '<span class="red"> <i  class="icon-check-empty bigger-150"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' +
                                    '</a>' + 
                                    '<a href="<?php echo U('Admin/Article/add');?>" class="tooltip-info" data-rel="tooltip" title="Add">' + 
                                        '<span class="blue"><i class="icon-plus-sign purple bigger-150"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' + 
                                    '</a>' + 
                                    '<a  class="tooltip-info" data-rel="tooltip" title="Delete">' + 
                                        '<span class="red"> <i class="icon-trash bigger-150"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>' +
                                    '</a>' +
                              '</label>';
                              
			    $("#sample-table-2_length").append(addBtn);
                */
			})
		</script>
        ...
        <script>
			jQuery(function($) {
			    ...
			    $('#deleteArticle').on('click', function(){ // ajax异步删除
                    ...
                    var url = "/index.php/Admin/Article/foreverDel";
