    ...
    <div class="container marketing">
        <div class="row">
            <div class="col-lg-8" style=" padding-left: 6px; padding-right: 13px; ">
                <!-- article list show photo -->
                <div id="myCarousel" class="carousel slide " data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="http://218.244.140.70/Uploads<?php echo (getthunmname($categoryInfo["image"])); ?>" class="advertImg"></a>
                            <div class="carousel-caption" style="padding-bottom: 150px">
                                <h1><?php echo ($categoryInfo["cname"]); ?></h1>
                                <p><?php echo ($categoryInfo["description"]); ?></p>

                                <div class="meta-author">
                                    <?php if(empty($categoryInfo["adminimage"])): ?><span class="avatar"><img style="width:30px;height:30px" class="img-circle" src="http://218.244.140.70/Public/images/admin.png" alt="Apacal" ></span>
                                    <?php else: ?>
                                    <span class="avatar"><img style="width:30px;height:30px" class="img-circle" src="http://218.244.140.70/Uploads<?php echo (getthunmname($categoryInfo["adminimage"])); ?>" ></span><?php endif; ?>
                                    <span class="author"><span class="dt">Author:</span> <span class="dd" ><a href="<?php echo U('Home/User/admin', array('id' => $categoryInfo['adminid']));?>" style="color:white"><?php echo ($categoryInfo["adminname"]); ?></a> · </span></span>
                                    <span class="publish-date"><span class="dt">Publish date:</span> <span class="dd" ><?php echo (date('F d, Y', $categoryInfo["createtime"])); ?></span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="view-summary-1">
                        ...
                        <div class="view-content">
                            ...
                            <p class="article-description">
                                <?php echo (msubstr($vo["description"],0,80)); ?>
                                &nbsp;&nbsp;&nbsp;<?php if(($vo["source"]) != "0"): ?><a target="_blank" href="<?php echo ($vo["source_link"]); ?>">转载</a><?php endif; ?>
                            </p>
                        </div>
                    </div>
                    <div class="meta">
    ...
    <div class="container marketing" id="footer">
                <script type="text/javascript">
                    ...
                    function showKeyDown(e) { 
                        ...
                        if(keycode == 74 || keycode == 8){ //如果按下J或者space 
                            $('html, body').animate({scrollTop: current + height - 40}, 'slow');
                            //在这里设置你想绑定的事件 
                        } 
                        if(keycode == 75 ){ //如果按下K键 
                            $('html, body').animate({scrollTop: current - height + 40}, 'slow');
                        }
                    } 
